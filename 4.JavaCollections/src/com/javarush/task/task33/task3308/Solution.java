...
public class Solution {
    public static void main(String[] args) throws JAXBException {
        ...
        System.out.println(o.count + "  12");
        System.out.println(o.profit + "  123.4");
        System.out.println(Arrays.toString(o.goods.names.toArray()));
        System.out.println(Arrays.toString(o.secretData));
