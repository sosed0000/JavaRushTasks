...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        List<int[][]> fireDown = new ArrayList<>();
        fireDown.add(ShapeMatrix.FIRE_DOWN_1);
        fireDown.add(ShapeMatrix.FIRE_DOWN_2);
        fireDown.add(ShapeMatrix.FIRE_DOWN_3);
        downFire = new RocketFire(fireDown);

        List<int[][]> fireLeft = new ArrayList<>();
        fireLeft.add(ShapeMatrix.FIRE_SIDE_1);
        fireLeft.add(ShapeMatrix.FIRE_SIDE_2);
        leftFire = new RocketFire(fireLeft);

        List<int[][]> fireRight = new ArrayList<>();
        fireRight.add(ShapeMatrix.FIRE_SIDE_1);
        fireRight.add(ShapeMatrix.FIRE_SIDE_2);
        rightFire = new RocketFire(fireRight);
    }
