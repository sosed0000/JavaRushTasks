...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(String.format("Как и большинство звездных систем, состоит из %d звезды.",
                SolarSystem.starsCount));
        System.out.println(String.format("Звезды по имени %s.", SolarSystem.starName));
        System.out.println(String.format("Расстояние к центру галактики составляет %d световых лет.",
